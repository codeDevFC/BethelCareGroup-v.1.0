...
import { 
  ...
  Utensils, Lock, Bell, ClipboardCheck
} from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto space-y-6 animate-in fade-in duration-700 pb-20">
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[10px] font-black text-red-600 uppercase tracking-wider">Compliance</span>
            </div>
            <h1 className="text-3xl lg:text-5xl font-black tracking-tighter">Health & Safety</h1>
            <p className="text-gray-500 text-sm mt-2 max-w-2xl">
              Complete health and safety checklist for Care Group home-based ministry.
              Ensure your group meets all compliance requirements.
            </p>
          </div>
            ...
            <div className="flex flex-wrap justify-between items-center gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Complete all required items before launching</p>
                </div>
              </div>
              <div className="flex gap-2">
                ...
                <button className="px-4 py-2 rounded-xl bg-red-600 text-white text-[10px] font-black hover:bg-red-700 transition-colors">
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-100">
            <h3 className="font-black text-green-800 mb-3">Leader Certification</h3>
            ...
            <div className="flex flex-wrap gap-4">
              <button className="px-6 py-3 bg-green-600 text-white rounded-2xl font-black text-[10px] uppercase tracking-wider hover:bg-green-700 transition-all">
                I Confirm Compliance
              </button>
              <Link href="/safety/checklist" className="px-6 py-3 bg-white text-green-600 rounded-2xl font-black text-[10px] uppercase tracking-wider border border-green-200 hover:bg-green-50 transition-all">
          ...
          <div className="bg-red-50 rounded-2xl p-6 border border-red-100">
            ...
            <div className="mt-4 pt-4 border-t border-red-200">
              <p className="text-[10px] text-red-600">
                Nearest A&E: [Insert local hospital name and address]
              </p>
              <p className="text-[10px] text-red-600 mt-1">
                Designated Safeguarding Lead: [Insert name and contact]
              </p>
            </div>
          </div>
        </div>
